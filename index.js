...
<<<<<<< HEAD
                ...
                console.log(
                    chalk.magenta(
                        `${global.themeemoji || "•"} GITHUB: mrunqiuehacker`
                    )
                );
                console.log(
                    chalk.magenta(
                ...
                console.log(
                    chalk.magenta(
                        `${global.themeemoji || "•"} CREDIT: MR UNIQUE HACKER`
                    )
                );
                console.log(
                    chalk.green(
            ...
            if (connection === "close") {
                ...
                if (
                    ...
                    try {
                        ...
                        console.log(
                            chalk.yellow(
                                "Session folder deleted. Please re-authenticate."
                            )
                        );
                    } catch (error) {
                    ...
                    console.log(
                        chalk.red("Session logged out. Please re-authenticate.")
                    );
                }
            ...
            try {
                ...
                for (const call of calls) {
                    ...
                    try {
                        ...
                        try {
                            if (
                                typeof XeonBotInc.rejectCall === "function" &&
                                call.id
                            ) {
                                await XeonBotInc.rejectCall(call.id, callerJid);
                            } else if (
                                typeof XeonBotInc.sendCallOfferAck ===
                                    "function" &&
                                call.id
                            ) {
                                await XeonBotInc.sendCallOfferAck(
                                    call.id,
                                    callerJid,
                                    "reject"
                                );
                        ...
                        if (!antiCallNotified.has(callerJid)) {
                            ...
                            setTimeout(
                                () => antiCallNotified.delete(callerJid),
                                60000
                            );
                    ...
                    setTimeout(async () => {
                        try {
                            await XeonBotInc.updateBlockStatus(
                                callerJid,
                                "block"
                            );
                        } catch {}
